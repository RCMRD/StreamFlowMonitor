			...
			<div class="col-lg-4 col-md-8 col-12">
				<div class="login-box bg-img rounded" style="background-image:url({{URL::asset('images/gallery/landscape6.jpg')}});" data-overlay="5">
				  ...
				  <center style="padding-top: 10px"> <img src="{{URL::asset('images/rcmrd.jpg')}}" width="70" height="70"/>
					<h3 class="text-center">Reset Password</h>
					
					 <form method="POST" action="{{ route('password.update') }}" class="form-element text-white">
                        @csrf
					<input type="hidden" name="token" value="{{ $token }}">
                      ...
                      <div class="form-group has-feedback">
						<input id="password"  type="password" name="password" class="form-control text-white" placeholder="Password">
					  ...
					  <div class="form-group has-feedback">
						<input id="password-confirm" name="password_confirmation" type="password" class="form-control text-white" placeholder="Retype password">
					  ...
					  <div class="row">
						...
						<div class="col-12 text-center">
						  <button type="submit" class="btn btn-success btn-block text-uppercase" onclick="waitingDialog.show('Please Wait', {dialogSize: 'sm', progressType: 'success'})">Reset Password</button>
						</div>
						<!-- /.col -->
					  </div>
					</form>
