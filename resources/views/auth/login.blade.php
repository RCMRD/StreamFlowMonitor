...
<body class="hold-transition  login-page bg">
			...
			<div class="col-lg-4 col-md-8 col-12">
				<div class="login-box bg-img rounded" style="background-image:url({{URL::asset('images/gallery/landscape6.jpg')}});" data-overlay="5">
				  ...
				  <center style="padding-top: 10px"> <img src="{{URL::asset('images/rcmrd.jpg')}}" width="70" height="70"/>
					...
					<h3 class="text-center">Projects Management System</h3>
					<p class="login-box-msg">Sign in to start your session</p>
					
					<form role="form" method="POST" action="{{ url('/login') }}"  class="form-element text-white" autocomplete="off">
                      {{ csrf_field() }}
					  ...
					  <div class="form-group has-feedback">
						...
						<input type="text" name="email" id="email" class="form-control text-white" placeholder="Email">
					  ...
					  <div class="form-group has-feedback">
						<input type="password" name="password"  id="password" class="form-control text-white" placeholder="Password">
					  ...
					  <div class="row">
						<div class="col-6">
						  <div class="checkbox">
							<input type="checkbox" id="basic_checkbox_1" onclick="showPassword()">
						...
						<div class="col-6">
						 <div class="fog-pwd text-right">
							<a href="{{ url('/password/reset') }}" class="text-white"><i class="ion ion-locked"></i> Reset password</a><br>
						  </div>
						</div>
						<!-- /.col -->
						<div class="col-12 text-center">
						  <button type="submit" class="btn btn-success btn-block margin-top-10" onclick="waitingDialog.show('Please Wait', {dialogSize: 'sm', progressType: 'success'})">SIGN IN</button>
						</div>
						<!-- /.col -->
					  </div>
					</form>
    ...
    if(key_attr != 'text') {
        ...
        $('.basic_checkbox_1').addClass('show');
        $('#password').attr('type', 'text');
        
    } else {
        
        $('.basic_checkbox_1').removeClass('show');
