    ...
    public function up()
    {
       ...
       /*Schema::table('expenses', function (Blueprint $table) {
        ...
        Schema::table('projects', function (Blueprint $table) {
			...
			$table->foreign('proposol_id')->references('id')->on('proposols');
            $table->foreign('created_by')->references('id')->on('users');        

        });
		
		
		Schema::table('proposols', function (Blueprint $table) {
            
            $table->foreign('customer_id')->references('id')->on('customers');           
            $table->foreign('status_id')->references('id')->on('proposol_statuses');
		...
		Schema::table('eois', function (Blueprint $table) {
            ...
            $table->foreign('customer_id')->references('id')->on('customers');           
            $table->foreign('status_id')->references('id')->on('eoi_statuses');
            $table->foreign('created_by')->references('id')->on('users');        
